...
f.OrderDate TransDateTime
, f.ETL__SSID_TM_acct_id TicketingAccountId, f.ETL__SourceSystem
, da.ArenaName
...
, ds.SeasonName, ds.SeasonYear, ds.SeasonClass, ds.Config_Org AS Sport
...
LEFT JOIN [ro].[vw_DimTicketClass] dtc ON f.DimTicketClassId = dtc.DimTicketClassId
LEFT JOIN  [ro].[vw_DimTicketType] dtt ON f.DimTicketTypeId = dtt.DimTicketTypeId
LEFT JOIN [ro].[vw_DimPlanType] dpt ON f.DimPlanTypeId = dpt.DimPlanTypeId
LEFT JOIN [ro].[vw_DimSeatType]  dstp ON f.DimSeatTypeId = dstp.DimSeatTypeId
